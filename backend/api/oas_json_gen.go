...
// Encode implements json.Marshaler.
func (s *APIHealthGetOK) Encode(e *jx.Encoder) {
	e.ObjStart()
	s.encodeFields(e)
	e.ObjEnd()
}
...
// encodeFields encodes fields.
func (s *APIHealthGetOK) encodeFields(e *jx.Encoder) {
	{
...
var jsonFieldsNameOfAPIHealthGetOK = [1]string{
	0: "message",
}

// Decode decodes APIHealthGetOK from json.
func (s *APIHealthGetOK) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode APIHealthGetOK to nil")
	}
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode APIHealthGetOK")
	}
	...
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfAPIHealthGetOK) {
					name = jsonFieldsNameOfAPIHealthGetOK[fieldIdx]
				} else {
...
// MarshalJSON implements stdjson.Marshaler.
func (s *APIHealthGetOK) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *APIHealthGetOK) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}
