...
const (
	ProblemService_SearchByKeyword_FullMethodName = "/atcodersearch.ProblemService/SearchByKeyword"
)
...
type ProblemServiceClient interface {
	SearchByKeyword(ctx context.Context, in *SearchProblemByKeywordRequest, opts ...grpc.CallOption) (*SearchProblemResult, error)
}
...
func (c *problemServiceClient) SearchByKeyword(ctx context.Context, in *SearchProblemByKeywordRequest, opts ...grpc.CallOption) (*SearchProblemResult, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SearchProblemResult)
...
type ProblemServiceServer interface {
	SearchByKeyword(context.Context, *SearchProblemByKeywordRequest) (*SearchProblemResult, error)
...
func (UnimplementedProblemServiceServer) SearchByKeyword(context.Context, *SearchProblemByKeywordRequest) (*SearchProblemResult, error) {
...
func _ProblemService_SearchByKeyword_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProblemServiceServer).SearchByKeyword(ctx, req.(*SearchProblemByKeywordRequest))
	}
...
var ProblemService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "atcodersearch.ProblemService",
