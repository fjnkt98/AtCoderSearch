...
func TestScrapeUsers(t *testing.T) {
	...
	want := []User{
		{UserName: "tourist", Rating: 3863, HighestRating: 4229, Affiliation: ptr("ITMO University"), BirthYear: ptr(1994), Country: ptr("BY"), Crown: ptr("crown_champion"), JoinCount: 59, Rank: 1, ActiveRank: ptr(1), Wins: 22},
		...
		{UserName: "ksun48", Rating: 3681, HighestRating: 3802, Affiliation: ptr("MIT"), BirthYear: ptr(1998), Country: ptr("CA"), Crown: ptr("crown_gold"), JoinCount: 58, Rank: 3, ActiveRank: ptr(2), Wins: 5},
		{UserName: "ecnerwala", Rating: 3663, HighestRating: 3814, Affiliation: ptr("MIT"), BirthYear: ptr(1997), Country: ptr("US"), Crown: ptr("crown_gold"), JoinCount: 36, Rank: 4, ActiveRank: ptr(3), Wins: 2},
		{UserName: "Benq", Rating: 3658, HighestRating: 3683, Affiliation: ptr("MIT"), BirthYear: ptr(2001), Country: ptr("US"), Crown: nil, JoinCount: 48, Rank: 5, ActiveRank: nil, Wins: 0},
		...
		{UserName: "apiad", Rating: 3600, HighestRating: 3852, Affiliation: nil, BirthYear: ptr(1997), Country: ptr("CN"), Crown: ptr("crown_gold"), JoinCount: 51, Rank: 7, ActiveRank: ptr(4), Wins: 6},
		{UserName: "Um_nik", Rating: 3571, HighestRating: 3948, Affiliation: nil, BirthYear: ptr(1996), Country: ptr("UA"), Crown: ptr("crown_gold"), JoinCount: 60, Rank: 8, ActiveRank: ptr(5), Wins: 7},
		{UserName: "mnbvmar", Rating: 3555, HighestRating: 3736, Affiliation: ptr("University of Warsaw"), BirthYear: ptr(1996), Country: ptr("PL"), Crown: ptr("crown_gold"), JoinCount: 22, Rank: 9, ActiveRank: ptr(6), Wins: 1},
		{UserName: "Stonefeang", Rating: 3554, HighestRating: 3658, Affiliation: ptr("University of Warsaw"), BirthYear: ptr(1997), Country: ptr("PL"), Crown: ptr("crown_gold"), JoinCount: 37, Rank: 10, ActiveRank: ptr(7), Wins: 2},
	}
