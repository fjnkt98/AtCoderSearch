...
<div class="flex-1 overflow-auto p-16">
  <div class="grid h-4/6 grid-cols-2 gap-4 p-2">
    <a class="block rounded-3xl bg-white p-4 no-underline shadow-lg" href="/search/problem?page=1&facet.term=category&facet.difficulty.from=0&facet.difficulty.to=4000&facet.difficulty.gap=400">
      <h3 class="font-roboto text-2xl">Search Problems</h3>
      <p class="py-3 text-gray-600">AtCoderの問題を検索します</p>
    </a>
    <a class="block rounded-3xl bg-white p-4 no-underline shadow-lg" href="/search/user?page=1&limit=50&facet=color,birth_year,country">
      <h3 class="font-roboto text-2xl">Search Users</h3>
      <p class="py-3 text-gray-600">AtCoderのユーザを検索します</p>
    </a>
    <a class="block rounded-3xl bg-white p-4 no-underline shadow-lg" href="/search/submission">
      <h3 class="font-roboto text-2xl">Submissions</h3>
      <p class="py-3 text-gray-600">全ての提出を表示します</p>
    </a>
    <a class="block rounded-3xl bg-white p-4 no-underline shadow-lg" href="/recommend/problem">
